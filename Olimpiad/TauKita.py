...
for i in range(1, 10):
    f1 = open(fr"C:\Users\csr10\OneDrive\Рабочий стол\Work\Тау-Кита\input_s1_0{i}.txt")
    f2 = open(fr"C:\Users\csr10\OneDrive\Рабочий стол\Work\Тау-Кита\output_s1_0{i}.txt")
    string = f1.readline()
